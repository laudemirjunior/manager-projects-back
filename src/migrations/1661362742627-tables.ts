...
export class tables1661362742627 implements MigrationInterface {
    name = 'tables1661362742627'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "tasks" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "conclude" boolean NOT NULL, "delivery" TIMESTAMP NOT NULL, "responsible" character varying NOT NULL, "projectId" uuid, CONSTRAINT "PK_8d12ff38fcc62aaba2cab748772" PRIMARY KEY ("id"))`);
